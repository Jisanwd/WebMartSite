...
{
    use HasFactory;
    private static $otherImage, $otherImages, $image, $imageName, $extension, $imageUrl, $directory;

    public static function getImageUrl($image)
    {
        self::$extension = $image->getClientOriginalExtension();
        self::$imageName = rand(1000, 5000).'.'.self::$extension;
        self::$directory ='otherImage-images/';
