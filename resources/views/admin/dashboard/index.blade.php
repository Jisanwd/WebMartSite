                ...
                <div class="quick-view-activity">
                    <ul class="list-media m-t-20">
                        ...
                        <li class="list-item border bottom">
                            <a href="javascript:void(0);" class="media-hover p-20">
                                <div class="media-img">
                                    <img src="{{asset('/')}}admin/assets/images/avatars/thumb-12.jpg" alt="">
                                </div>
                                <div class="info">
                        ...
                        <li class="list-item border bottom">
                            <a href="javascript:void(0);" class="media-hover p-20">
                                <div class="media-img">
                                    <img src="{{asset('/')}}admin/assets/images/avatars/thumb-11.jpg" alt="">
                                </div>
                                <div class="info">
                            ...
                            <ul class="list-unstyled">
                                <li class="p-v-15 border bottom">
                                    <a href="#">
                                        <div class="media">
                                            <div class="m-r-20">
                                                <img class="img-fluid" src="{{asset('/')}}admin/assets/images/others/img-35.jpg" alt="">
                                            </div>
                                            <div >
                                ...
                                <li class="p-v-15">
                                    <a href="#">
                                        <div class="media">
                                            <div class="m-r-20">
                                                <img class="img-fluid" src="{{asset('/')}}admin/assets/images/others/img-34.jpg" alt="">
                                            </div>
                                            <div >
