        ...
        <div class="col-lg-10 mx-auto">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row mb-4">
                        <label for="horizontal-firstname-input" class="col-sm-10 col-form-label"><h4 class="text-center">Edit Unit Form</h4></label>
                    </div>
                    ...
                    <form action="{{route('unit.update', ['id' => $unit->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <textarea class="form-control" rows="5" name="description">{{$unit->description}}</textarea>
                            </div>
                        </div>
